...
class EventCfg:
    ...
    cabinet_joint_stiffness_and_damping = EventTerm(
...
@configclass
class FrankaCabinetRDEnvCfg(DirectRLEnvCfg):
    # env
...
class FrankaCabinetRDEnv(DirectRLEnv):
    ...
    cfg: FrankaCabinetRDEnvCfg

    def __init__(self, cfg: FrankaCabinetRDEnvCfg, render_mode: str | None = None, **kwargs):
